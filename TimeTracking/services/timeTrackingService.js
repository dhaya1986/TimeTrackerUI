app.service('timeTrackingService', ['genericSetting', 'perDimensionSetting', 'restProvider', '$window', '$q', '$http',
    function (genericSetting, perDimensionSetting, restProvider, $window, $q, $http) {
